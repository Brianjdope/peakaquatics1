...
export const MILESTONES = [
  { tag: 'USA National Team',        time: '2026–27',  event: 'Team USA Roster',    name: 'Kate Hurst',      date: 'Aug 2026' },
  ...
  { tag: 'World Juniors — 4th',      time: '16:22.56', event: '1500M Freestyle',    name: 'Chloe Kim',       date: '2025' },
...
export const ARTICLES = {
  'kate-hurst-national-team-2026': {
    ...
    credit: {
      label: 'Photos via SwimSwam.',
      linkText: 'View on Instagram',
      url: 'https://www.instagram.com/p/DcwCvJDlGNv/?img_index=1',
    },
  ...
  'speedo-sectionals-2026': {
    ...
    body: [
      ...
      'Ethan Reines (14) opened the meet with a Winter Junior National qualifying time in the 1500M Freestyle (16:12.64). Ryker Levi (15) posted a personal best of 23.89 in the 50M Freestyle and swam a 24.78 in the 50M Butterfly — a brand new event. Ava Lan (15) earned a Junior National qualifying time and personal best in the 800M Freestyle (9:03.22).',
      'Day 2 — March 27:',
      'Ryker Levi achieved a lifetime best of 54.14 in the 100M Butterfly, making the Toyota National Championship cut. Joshua Reines (16) qualified for Junior Nationals in the 200M Breaststroke with a time of 2:20.91. Ethan Reines posted a personal best of 2:10.03 in the 200M Backstroke. Ava Lan went a personal best of 5:03.49 in the 400M IM.',
      'Day 3 — March 28:',
  ...
  'ethan-state-record': {
    ...
    body: [
      'Our team delivered an outstanding performance at the 2026 NJS & Scarlet 11 & Over Gold Championships, highlighted by multiple lifetime bests, record-breaking swims, and impressive finishes across the board.',
      'MARCH 19 HIGHLIGHTS',
      'Ethan Reines (14) kicked off the meet in dominant fashion, capturing 1st place in the 1650 Freestyle with a lifetime best time of 15:48.39. Teammate Sebastian Hendrawan (17) also delivered a strong performance, posting a personal best of 16:07.22 in the same event.',
      'MARCH 20 HIGHLIGHTS',
      'Ethan continued his incredible weekend by breaking the New Jersey State Record in the 500 Freestyle with a blazing time of 4:30.88.',
      'In the 200 Individual Medley, Yuriel Lee (16) and Joshua Reines (16) both achieved lifetime bests, touching in 1:51.49 and 1:51.64, respectively. Cheryn Cho added to the momentum with a personal best of 53.54 in the 100 Freestyle.',
      'Butterfly events saw major breakthroughs as Chase Kim (14) recorded a lifetime best of 50.91 in the 100 Fly, while Ryker Levi (15) followed closely with a personal best of 46.94.',
      'Distance success continued with Ava Lan (15), who posted a best time of 4:56.56 in the 500 Freestyle, and Milo Pfeifer (16), who clocked a lifetime best of 4:40.25.',
      'In breaststroke, Joshua Reines added another personal best (2:01.38) in the 200 Breaststroke, while Sebastian Hendrawan posted a lifetime best of 2:05.22.',
      'MARCH 21 HIGHLIGHTS',
      'The 200 Butterfly brought more standout swims, led by Chase Kim\'s lifetime best of 1:50.88. Ryker Levi and Connor Hong also delivered exceptional performances, recording personal bests of 1:47.52 and 1:52.43, respectively.',
      'MARCH 22 HIGHLIGHTS',
      'Joshua Reines broke the 4-minute barrier in the 400 Individual Medley with a lifetime best of 3:58.98, followed closely by Ethan Reines at 3:59.61, marking another major milestone for the team.',
      'Ryker Levi capped off the meet with a personal best of 20.55 in the 50 Freestyle.',
      'Congratulations to all of our swimmers for their hard work and dedication throughout the weekend. We are incredibly proud of these performances and the continued progress of our team.',
      'Best of luck to our athletes advancing to Sectionals and YMCA Nationals—we\'re excited to see what\'s next!',
    ],
  },
  'tyr-2026': {
    tag: 'Competition',
  ...
  'jacob-cmu': {
    ...
    body: [
      ...
      'I would also like to thank the UC San Diego coaching staff for this amazing opportunity.',
      'GO TRITONS!',
...
export const RECORDS_TABLES = {
  ...
  'scy-men': buildTable("SCY Men's Open", [
    ...
    r('100 Fly',    p('Ryker Levi',          '46.94',    2026), p('Richard Poplawski',   '48.16',    2024), p('Harrison Lee',         '48.80',    2026)),
  ...
  'lcm-men': buildTable("LCM Men's Open", [
    ...
    r('200 Fly',    p('Ryker Levi',          '2:01.10',  2026), p('Richard Poplawski',   '2:01.40',  2024), p('Chase Kim',            '2:05.56',  2026)),
    r('50 Breast',  p('Sean Darder',         '29.92',    2026), p('Will Mulder',         '30.99',    2026), p('',                    '',         '')),
    r('100 Breast', p('Eric Lee',            '1:04.49',  2023), p('Dimitri Melnikov',    '1:05.18',  2024), p('Joshua Reines',        '1:05.67',  2026)),
    r('200 Breast', p('Joshua Reines',       '2:20.09',  2026), p('Eric Lee',            '2:21.52',  2022), p('Michael Granin',       '2:23.48',  2024)),
    r('200 IM',     p('Richard Poplawski',   '2:03.26',  2024), p('Eric Lee',            '2:04.96',  2022), p('Timothy Lee',          '2:08.05',  2025)),
    r('400 IM',     p('Richard Poplawski',   '4:24.52',  2024), p('Eric Lee',            '4:26.05',  2022), p('Joshua Reines',        '4:32.76',  2026)),
  ]),
...
export const ABOUT = {
  mission: 'Peak Aquatic Sports is a professional swimming consultancy dedicated to empowering parents and student-athletes to achieve their short- and long-term goals, both in and beyond the pool. Through the sport of swimming, we impart knowledge and instill the enduring values of integrity, humility, and discipline — shaping not only stronger swimmers, but stronger individuals.',
